...
namespace PROManager.Controllers
{
    public class RefereesController : Controller
    {
        ...
        public RefereesController(PROManagerContext context)
        {
            _context = context;
        }
        ...
        {
            var pROManagerContext = _context.Referee.Include(r => r.Person);
        ...
        public async Task<IActionResult> Create([Bind("Id,PersonId")] Referee referee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PersonId")] Referee referee)
        {
            if (id != referee.Id)
            {
                return NotFound();
